...
class MicroneedlingScreen extends StatefulWidget {
  const MicroneedlingScreen({super.key});

  @override
  _MicroneedlingScreenState createState() => _MicroneedlingScreenState();
}

class _MicroneedlingScreenState extends State<MicroneedlingScreen> {
  ...
  Future<void> _checkInternetConnection() async {
    ...
    if (connectivityResult == ConnectivityResult.none) {
      ...
      _controller.loadRequest(Uri.parse("https://4everyoungstl.com/specials/microneedling/"));
    }
  }
