...
class PlateletRichPlasmaScreen extends StatefulWidget {
  const PlateletRichPlasmaScreen({super.key});

  @override
  _PlateletRichPlasmaScreenState createState() => _PlateletRichPlasmaScreenState();
}

class _PlateletRichPlasmaScreenState extends State<PlateletRichPlasmaScreen> {
  ...
  Future<void> _checkInternetConnection() async {
    ...
    if (connectivityResult == ConnectivityResult.none) {
      ...
      _controller.loadRequest(Uri.parse("https://4everyoungstl.com/specials/prp/"));
    }
  }
