...
class MesotherapyScreen extends StatefulWidget {
  const MesotherapyScreen({super.key});

  @override
  _MesotherapyScreenState createState() => _MesotherapyScreenState();
}

class _MesotherapyScreenState extends State<MesotherapyScreen> {
  ...
  Future<void> _checkInternetConnection() async {
    ...
    if (connectivityResult == ConnectivityResult.none) {
      ...
      _controller.loadRequest(Uri.parse("https://4everyoungstl.com/specials/mesotherapy/"));
    }
  }
