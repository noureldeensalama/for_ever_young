...
class ViPeelScreen extends StatefulWidget {
  const ViPeelScreen({super.key});

  @override
  _ViPeelScreenState createState() => _ViPeelScreenState();
}

class _ViPeelScreenState extends State<ViPeelScreen> {
  ...
  Future<void> _checkInternetConnection() async {
    ...
    if (connectivityResult == ConnectivityResult.none) {
      ...
      _controller.loadRequest(Uri.parse("https://4everyoungstl.com/specials/vi-peel-in-st-louis-mo/"));
    }
  }
