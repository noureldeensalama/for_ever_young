...
class CreamBleachingScreen extends StatefulWidget {
  const CreamBleachingScreen({super.key});

  @override
  _CreamBleachingScreenState createState() => _CreamBleachingScreenState();
}

class _CreamBleachingScreenState extends State<CreamBleachingScreen> {
  ...
  Future<void> _checkInternetConnection() async {
    ...
    if (connectivityResult == ConnectivityResult.none) {
      ...
      _controller.loadRequest(Uri.parse("https://4everyoungstl.com/specials/cream-bleaching/"));
    }
  }
