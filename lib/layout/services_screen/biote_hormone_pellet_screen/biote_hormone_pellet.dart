...
class BioteHormonePellet extends StatefulWidget {
  const BioteHormonePellet({super.key});

  @override
  _BioteHormonePelletState createState() => _BioteHormonePelletState();
}

class _BioteHormonePelletState extends State<BioteHormonePellet> {
  ...
  Future<void> _checkInternetConnection() async {
    ...
    if (connectivityResult == ConnectivityResult.none) {
      ...
      _controller.loadRequest(Uri.parse("https://4everyoungstl.com/specials/biote/"));
    }
  }
