...
class IvTherapyScreen extends StatefulWidget {
  const IvTherapyScreen({super.key});

  @override
  _IvTherapyScreenState createState() => _IvTherapyScreenState();
}

class _IvTherapyScreenState extends State<IvTherapyScreen> {
  ...
  Future<void> _checkInternetConnection() async {
    ...
    if (connectivityResult == ConnectivityResult.none) {
      ...
      _controller.loadRequest(Uri.parse("https://4everyoungstl.com/iv-therapy/"));
    }
  }
