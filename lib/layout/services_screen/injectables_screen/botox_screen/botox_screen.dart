...
class BotoxScreen extends StatefulWidget {
  const BotoxScreen({super.key});

  @override
  _BotoxScreenState createState() => _BotoxScreenState();
}

class _BotoxScreenState extends State<BotoxScreen> {
  ...
  Future<void> _checkInternetConnection() async {
    ...
    if (connectivityResult == ConnectivityResult.none) {
      ...
      _controller.loadRequest(Uri.parse("https://4everyoungstl.com/specials/botox/"));
    }
  }
