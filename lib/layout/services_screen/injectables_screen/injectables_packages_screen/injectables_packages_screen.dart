...
class InjectablesPackagesScreen extends StatefulWidget {
  const InjectablesPackagesScreen({super.key});

  @override
  _InjectablesPackagesScreenState createState() => _InjectablesPackagesScreenState();
}

class _InjectablesPackagesScreenState extends State<InjectablesPackagesScreen> {
  ...
  Future<void> _checkInternetConnection() async {
    ...
    if (connectivityResult == ConnectivityResult.none) {
      ...
      _controller.loadRequest(Uri.parse("https://4everyoungstl.com/injectables/"));
    }
  }
