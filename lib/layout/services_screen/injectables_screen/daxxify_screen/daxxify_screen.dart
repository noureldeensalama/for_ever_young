...
class DaxxifyScreen extends StatefulWidget {
  const DaxxifyScreen({super.key});

  @override
  _DaxxifyScreenState createState() => _DaxxifyScreenState();
}

class _DaxxifyScreenState extends State<DaxxifyScreen> {
  ...
  Future<void> _checkInternetConnection() async {
    ...
    if (connectivityResult == ConnectivityResult.none) {
      ...
      _controller.loadRequest(Uri.parse("https://4everyoungstl.com/specials/daxxify/"));
    }
  }
