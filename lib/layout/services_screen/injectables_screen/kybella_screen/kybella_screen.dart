...
class KybellaScreen extends StatefulWidget {
  const KybellaScreen({super.key});

  @override
  _KybellaScreenState createState() => _KybellaScreenState();
}

class _KybellaScreenState extends State<KybellaScreen> {
  ...
  Future<void> _checkInternetConnection() async {
    ...
    if (connectivityResult == ConnectivityResult.none) {
      ...
      _controller.loadRequest(Uri.parse("https://4everyoungstl.com/specials/kybella/"));
    }
  }
