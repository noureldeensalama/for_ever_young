...
class DermaFillersScreen extends StatefulWidget {
  const DermaFillersScreen({super.key});

  @override
  _DermaFillersScreenState createState() => _DermaFillersScreenState();
}

class _DermaFillersScreenState extends State<DermaFillersScreen> {
  ...
  Future<void> _checkInternetConnection() async {
    ...
    if (connectivityResult == ConnectivityResult.none) {
      ...
      _controller.loadRequest(Uri.parse("https://4everyoungstl.com/specials/dermal-fillers/"));
    }
  }
