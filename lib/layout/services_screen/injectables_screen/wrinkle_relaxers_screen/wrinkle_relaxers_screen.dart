...
class WrinkleRelaxersScreen extends StatefulWidget {
  const WrinkleRelaxersScreen({super.key});

  @override
  _WrinkleRelaxersScreenState createState() => _WrinkleRelaxersScreenState();
}

class _WrinkleRelaxersScreenState extends State<WrinkleRelaxersScreen> {
  ...
  Future<void> _checkInternetConnection() async {
    ...
    if (connectivityResult == ConnectivityResult.none) {
      ...
      _controller.loadRequest(Uri.parse("https://4everyoungstl.com/specials/wrinkle-relaxers/"));
    }
  }
