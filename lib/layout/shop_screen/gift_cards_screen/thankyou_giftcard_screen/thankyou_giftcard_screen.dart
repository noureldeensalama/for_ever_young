...
class ThankYouGiftcardScreen extends StatefulWidget {
  const ThankYouGiftcardScreen({super.key});

  @override
  _ThankYouGiftcardScreenState createState() => _ThankYouGiftcardScreenState();
}

class _ThankYouGiftcardScreenState extends State<ThankYouGiftcardScreen> {
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Center(
                child: Image.asset(
                  'images/shop_screen_photos/giftcards_photos/thankyou.png',
