...
class CongratulationsGiftcardScreen extends StatefulWidget {
  const CongratulationsGiftcardScreen({super.key});

  @override
  _CongratulationsGiftcardScreenState createState() => _CongratulationsGiftcardScreenState();
}

class _CongratulationsGiftcardScreenState extends State<CongratulationsGiftcardScreen> {
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Center(
                child: Image.asset(
                  'images/shop_screen_photos/giftcards_photos/congrats.png',
