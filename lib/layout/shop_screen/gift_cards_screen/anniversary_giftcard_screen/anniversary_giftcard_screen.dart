...
class anniversaryGiftcardScreen extends StatefulWidget {
  const anniversaryGiftcardScreen({super.key});

  @override
  _anniversaryGiftcardScreenState createState() => _anniversaryGiftcardScreenState();
}

class _anniversaryGiftcardScreenState extends State<anniversaryGiftcardScreen> {
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Center(
                child: Image.asset(
                  'images/shop_screen_photos/giftcards_photos/anniversary.png',
